//
//  AbExercisesTableViewController.swift
...
class AbExercisesTableViewController: UITableViewController, UISearchBarDelegate {

    
    @IBOutlet var abTable: UITableView!
    ...
    func searchBar(searchBar: UISearchBar, textDidChange searchText: String) {
        ...
        if searchText.isEmpty {
            ...
            filteredData = abExercises.filter({(dataItem: String) -> Bool in
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier("abExerciseCell", forIndexPath: indexPath)
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        text = abExercises[indexPath.row]
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        func searchBar(searchBar: UISearchBar, textDidChange searchText: String) {
            filteredData = searchText.isEmpty ? abExercises : abExercises.filter({(dataString: String) -> Bool in
